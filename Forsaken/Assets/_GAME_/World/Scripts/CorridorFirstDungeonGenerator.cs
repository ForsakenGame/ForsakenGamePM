...
public class CorridorFirstDungeonGenerator : SimpleRandomWalkMapGen
{
    ...
    private void CorridoFirstGeneration()
    {
    ...
    private List<Vector2Int> IncreaseCorridorSizeByOne(List<Vector2Int> corridor)
    {
        ...
        for (int i = 1; i < corridor.Count; i++)
        {
            ...
            else
            {
                ...
                Vector2Int newCorridorTileOffset = GetDirections90From(directionFromCell);
    ...
    private Vector2Int GetDirections90From(Vector2Int direction)
    {
    ...
    private List<List<Vector2Int>> CreateCorridors(HashSet<Vector2Int> floorPositions, HashSet<Vector2Int> potentialRoomPositions)
    {
        ...
        {
            var corridor = ProceduralGenAlgorithms.RandomWalkCorridor(currentPosition, _corridorLength);
